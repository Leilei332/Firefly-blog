...
目前正在用的是[Debian](../j2021-debian-11/)，最新版本11 bulleye
...
其中因为没有删前面的Kubuntu系统，在第二次操作中移动的**/boot/efi**分区而导致Manjaro无法启动[^1]，只好重装Manjaro，后面就没怎么做死了。

导致我放弃Manjaro的是它的滚动更新的机制，因为滚动更新，所以Gnome升级到了40.0版本，而且非常不稳定，切换窗口都会崩溃，只能注销，所以又换回了Kubuntu。

<!--TODO: Joplin补档-->

当时Kubuntu一直在用，然后Debian 11就出了，当时有点想升级，Kubuntu也因为内核升级的原因出了问题。当时在知乎上看到了Debian与Ubuntu的对比，也知道了nonfree镜像版本（见[Debian 11安装](../j2021-debian-11/))，所以安装了。
...
[^1]: 移动任何操作系统的启动分区都会导致系统无法启动，因此现在GParted会显示警告（2026.5.21）
