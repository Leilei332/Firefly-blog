...
西里尔字母Ее的一个变体，如同字符名称在乌克兰语中使用，表示发音/je/或/jɛ/。这个字母也曾在塞尔维亚语中使用，之后被је代替。
...
虽然Ыы是个常用字母，但它的外观值得讲一下。这个字母看上去是由Ь和І组合而来的，但实际上是由Ъ和І组合的，Ꙑꙑ是它的原始形式。
...
早期西里尔字母，来源于希腊字母Ωω，表示发音/ɔ/，但由于斯拉夫语言通常只有一个/ɔ/发音，因此这个字母在绝大多数情况下被Оо取代。

在西里尔数字系统中，这个字母代表数字800。
...
西里尔早期字母表的字母，对应格拉高里字母Ⱑⱑ。这个字母曾广泛用于斯拉夫语言中，之后被废除。俄语在1918年的正字法改革中将其废除，保加利亚语在1945年的正字法改革中将其废除。
